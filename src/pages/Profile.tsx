...
const Profile = () => {
  ...
  // REMOVED: organisationVisibilityInput
  ...
  // REMOVED: isOrganisationClickTooltipOpen
  ...
  // REMOVED: Organisation icon hover tooltip states
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Manage your organisations and their individual visibility settings.
              </p>
              <OrganisationManager
                organisations={organisationInput}
                onUpdateOrganisations={setOrganisationInput}
              />
            </CardContent>
          </Card>
