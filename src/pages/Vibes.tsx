      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8"> {/* Changed to 2 columns for large screens for a 2x2 layout */}
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-sm text-muted-foreground">
            ...
            <p>
              <Link to="/profile" className="text-blue-500 hover:underline">Focus Preferences</Link> indicate your sociability to attract aligned coworking.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4 text-sm text-muted-foreground">
            ...
            <p> DeepSesh currently has weak security.<br />Data shared may be easily accessible to hackers. Share information at own risk.
          </CardContent>
        </Card>
      </div>
