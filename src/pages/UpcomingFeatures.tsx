...
const UpcomingFeatures = () => {
  const features = [
    ...
    { name: "User Verification", cost: "$6,000", description: "Implement robust identity verification to enhance trust and security within the community. <br> Filter to only interact with verified coworkers." },
